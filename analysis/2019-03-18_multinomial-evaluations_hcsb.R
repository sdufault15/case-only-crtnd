...
sims <- sample_size_function(df = data, periods = periods, lambdas = c(1, 0.6, 0.5, 0.4, 0.3), hcsb = c(1, 0.95, 0.85, 0.5), ns = 1000, print = FALSE)
multinom_hcsb_1000 <- performance_function(sims, m = 12, zstar = 1.96, estimator = c("AggOR", "ME.GEE", "TP"))
save(multinom_no_hcsb_1000, file = "output/2019-03-18_multinom_hcsb_1000.RData")